...
### Открытые вопросы для решения перед V1
1. **Категория тикета `verification_request`** — добавляем сейчас в enum, или владелец просто пишет в общий саппорт?
2. **Истечение верификации** — бессрочная, или раз в год нужно подтверждать заново? (предлагаю бессрочную для MVP).
3. **Влияние сброса верификации на Trust Score** — мгновенно −15 или плавный спад за 30 дней?
